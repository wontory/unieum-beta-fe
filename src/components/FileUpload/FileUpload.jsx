...
const FileUpload = () => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      console.log(res);
      answerCtx.onSaveAnswers("promptV1", res.data.data.v1TestList);
      answerCtx.onSaveAnswers("promptV2", res.data.data.v2TestList);
      answerCtx.onSaveAnswers("promptV3", res.data.data.v3TestList);
